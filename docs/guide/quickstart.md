...
Check if your Python file is compatible with MultiGen:

```bash
multigen check fibonacci.py
```

This reports whether the file is valid, its tier level, and any violations -- without generating any code.
...
- [Backend Guide](backends.md) -- Learn about backend-specific features
- [Pipeline API](../api/pipeline.md) -- API reference for programmatic use
